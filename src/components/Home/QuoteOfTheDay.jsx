...
function QuoteOfTheDay() {
    ...
    return (
        <div className="flex flex-col my-12 max-w-4xl mx-auto px-4 mt-32">
            ...
            <div className="relative flex flex-row border-solid rounded-3xl bg-gray-200 shadow-lg min-h-[400px] ">
                <div className="w-3/4">
                    <img
                        src={img1}
                        className="rounded-l-3xl h-full object-cover"
                        alt="Inspirational scene"
                    />
                </div>

                <div className="w-2/3 p-6 flex flex-col justify-center">
                    <b className="text-lg md:text-xl text-gray-800 maksymalny mb-4">{quote}</b>
